...
public class FluidUtils {
    ...
    public static ForgeFlowingFluid.Properties createFluidProperties(final Supplier<? extends RavenFlowingFluid> fluid, final Supplier<? extends RavenFlowingFluid> flowingFluid, final int color, final Supplier<? extends RavenLiquidBlock> block, final Supplier<? extends RavenBucketItem> bucket) {
